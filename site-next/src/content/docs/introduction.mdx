...
<Aside type="note">
<span>These benchmarks are run against a local Anvil instance (mainnet fork). Real-world performance will vary depending on your RPC provider, network latency, and workload shape.</span>
</Aside>
