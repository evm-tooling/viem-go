...
<div className="docs-feature-table">
  ...
  {[
    ...
    <div key={feature} className="docs-feature-table__row">
      <span className="docs-feature-table__name">{feature}</span>
      <span className="docs-feature-table__status docs-feature-table__status--complete">✅ Complete</span>
    </div>
  ))}
</div>
