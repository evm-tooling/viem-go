  ...
  return (
    <div
      className={cn(
        ...
        depth === 1 && (isActive ? "!border-primary" : "!border-border/30"),
      )}
      onClick={onToggle}
  ...
  return (
    <div
      className={cn(
        "w-full",
        depth === 1 && "border-l-2 transition-colors duration-150",
        depth === 1 && (childActive ? "!border-primary" : "!border-border/30"),
      )}
      onClick={handleClick}
    >
      <div
      ...
      >
        <Button
          ...
          className={cn(
            ...
            depth > 1 ? "pl-4" : "pl-4",
            childActive ? "text-foreground font-semibold" : "text-foreground-muted"
          )}
        >
          {showHighlight ? <Highlight /> : null}
          ...
          <motion.svg
            ...
            className="shrink-0 text-foreground-muted relative z-10"
          >
...
function NavSection({
  ...
  return (
    <div className="mt-1 first:mt-0">
      <span className="flex items-center text-[0.8125rem] font-bold text-foreground uppercase tracking-wider mb-2 py-1 px-3">
        {item.label}
      </span>
      {item.items && (
...
function SocialFooter() {
  return (
    <div className="flex items-center gap-3 px-4 py-4 border-t border-border/50 mt-auto">
      <Button
        asChild
        variant="ghost"
        size="sm"
        className="h-9 w-9 p-0 rounded-md text-foreground-muted hover:text-foreground"
      >
        <a href="https://github.com/ChefBingbong/viem-go" target="_blank" rel="noopener noreferrer" title="GitHub">
      ...
      <Button
        ...
        className="h-9 w-9 p-0 rounded-md text-foreground-muted hover:text-foreground"
      >
        <a href="https://twitter.com/ChefBingbong" target="_blank" rel="noopener noreferrer" title="Twitter">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
      ...
      <Button
        ...
        className="h-9 w-9 p-0 rounded-md text-foreground-muted hover:text-foreground"
      >
        <a href="https://discord.gg/your-discord" target="_blank" rel="noopener noreferrer" title="Discord">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
