  ...
  return (
    <section className="w-full py-8 px-8">
      <div className="max-w-[1120px] mx-auto mb-10 text-center">
        <h2 className="heading-2 mb-2">Support</h2>
      ...
      <div className="flex justify-center gap-6 flex-wrap">
        <Button
          ...
          variant="secondary"
          size="lg"
          className="h-auto py-4 px-6 rounded-xl font-semibold transition-all duration-200 hover:bg-gray-6/70 hover:-translate-y-0.5"
        >
          <a
